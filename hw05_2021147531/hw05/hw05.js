...
function render() {
    ...
    let yAxisOscillation =  cameraMaxHeight * Math.sin(glMatrix.toRadian(cameraHeightSpeed * elapsedTime)) + 5.0;
    ...
    mat4.lookAt(viewMatrix, 
        vec3.fromValues(camX, yAxisOscillation, camZ), // camera position
        vec3.fromValues(0, 0, 0), // look at origin
        vec3.fromValues(0, 1, 0)); // up vector

    console.log(yAxisOscillation);
